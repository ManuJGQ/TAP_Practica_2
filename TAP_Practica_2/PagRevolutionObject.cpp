...
void PagRevolutionObject::createObject() {
	if (nombreAlumno == "mesa") material = PagMaterial(glm::vec3(0.55, 0.27, 0.07), glm::vec3(0.55, 0.27, 0.07), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b1") material = PagMaterial(glm::vec3(1.0, 0.55, 0.0), glm::vec3(1.0, 0.55, 0.0), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b2") material = PagMaterial(glm::vec3(0.36, 0.36, 0.36), glm::vec3(0.36, 0.36, 0.36), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b3") material = PagMaterial(glm::vec3(1.0, 0.55, 0.0), glm::vec3(1.0, 0.55, 0.0), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b4") material = PagMaterial(glm::vec3(1.0, 0.55, 0.0), glm::vec3(1.0, 0.55, 0.0), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b5") material = PagMaterial(glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b6") material = PagMaterial(glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b7") material = PagMaterial(glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0));
	if (nombreAlumno == "b8") material = PagMaterial(glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0));
		...
		if (nShader == "Texture-P" || nShader == "Texture-D" || nShader == "Texture-S") {
			...
			if (l == 'P') {
				...
				if (!shader->getUniformsRealizados()) {
					shader->setUniform("Ks", material.getKs());
